...
export interface ItemERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface ItemERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): ItemERC1155;
  waitForDeployment(): Promise<this>;

  interface: ItemERC1155Interface;
  ...
  setMaxSupply: TypedContractMethod<
    [id: BigNumberish, newMaxSupply: BigNumberish],
    [void],
    "nonpayable"
  >;

  setSoulbound: TypedContractMethod<
    [id: BigNumberish, isSoulbound: boolean],
    [void],
    "nonpayable"
  >;
